const questions = [
  {
    questionText: "Who would you trust to manage a housing estate?",
    options: [
  ...
  {
    questionText: "Who would you trust to repair your car's engine?",
    options: [
  ...
  {
    questionText: "Who would you trust to plan your wedding?",
    options: [
  ...
  {
    questionText: "Who would you trust to provide medical advice?",
    options: [
  ...
  {
    questionText: "Who would you trust to give you a haircut?",
    options: [
  ...
  {
    questionText: "Who would you trust to design your website?",
    options: [
      "1. A friend who knows how to use Microsoft Word",
      "2. A professional web designer with experience and a portfolio",
      "3. A person who has never used a computer before",
      "4. A comedian with no knowledge of web design",
    ],
    answer: "2. A professional web designer with experience and a portfolio",
  },
  {
    questionText: "Who would you trust to babysit your child?",
    options: [
  ...
  {
    questionText: "Who would you trust to handle your legal matters?",
    options: [
